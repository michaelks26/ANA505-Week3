...
new_dataframe = tibble(height2 = height,
                       weight2 = weight)
...
women[which(new_dataframe$height2 > 65),]
...
ggplot(new_dataframe, aes(x=height2, y=weight2)) + 
  geom_point()
